...
public class DownloadTorrent {
    ...
    public DownloadTorrent(String peerAddress, String peerPort, TorrentStateModel torrentStateModel) {
    ...
    public void getAndSavePiece(String outputFileName, int pieceIdx) {
        try {
